...
for t=1:nRlz
    ...
    observed_std  = zeros(prod(dim),1);
      ...
      observed_residual_std        = alpha*beta*sqrt(1+observed_cohen_d.^2*(beta^2)); 
      ...
      for i=1:nSubj
          ...
          standardized_cohen_resid = spdiags(1./observed_residual_std, 0,prod(dim),prod(dim))*cohen_resid;
