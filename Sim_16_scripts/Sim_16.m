...
for t=1:nRlz
    ...
    max_min_lower_contour_raw_80             = observed_cohen_d >= thr - supGa_max_raw_80*tau*observed_cohen_d_std;
    max_min_upper_contour_raw_80             = observed_cohen_d >= thr - supGa_min_raw_80*tau*observed_cohen_d_std;
    ...
    max_min_lower_contour_raw_90             = observed_cohen_d >= thr - supGa_max_raw_90*tau*observed_cohen_d_std;
    max_min_upper_contour_raw_90             = observed_cohen_d >= thr - supGa_min_raw_90*tau*observed_cohen_d_std;
    ...
    max_min_lower_contour_raw_95             = observed_cohen_d >= thr - supGa_max_raw_95*tau*observed_cohen_d_std;
    max_min_upper_contour_raw_95             = observed_cohen_d >= thr - supGa_min_raw_95*tau*observed_cohen_d_std;
    ...
    max_min_lower_contour_observed_80             = observed_cohen_d >= thr - supGa_max_observed_80*tau*observed_cohen_d_std;
    max_min_upper_contour_observed_80             = observed_cohen_d >= thr - supGa_min_observed_80*tau*observed_cohen_d_std;
    ...
    max_min_lower_contour_observed_90             = observed_cohen_d >= thr - supGa_max_observed_90*tau*observed_cohen_d_std;
    max_min_upper_contour_observed_90             = observed_cohen_d >= thr - supGa_min_observed_90*tau*observed_cohen_d_std;
    ...
    max_min_lower_contour_observed_95             = observed_cohen_d >= thr - supGa_max_observed_95*tau*observed_cohen_d_std;
    max_min_upper_contour_observed_95             = observed_cohen_d >= thr - supGa_min_observed_95*tau*observed_cohen_d_std;
    ...
    max_min_lower_condition_80 = thr - supGa_max_raw_80*tau*observed_cohen_d_std;
    max_min_upper_condition_80 = thr - supGa_min_raw_80*tau*observed_cohen_d_std;
    max_min_lower_condition_90 = thr - supGa_max_raw_90*tau*observed_cohen_d_std;
    max_min_upper_condition_90 = thr - supGa_min_raw_90*tau*observed_cohen_d_std;
    max_min_lower_condition_95 = thr - supGa_max_raw_95*tau*observed_cohen_d_std;
    max_min_upper_condition_95 = thr - supGa_min_raw_95*tau*observed_cohen_d_std;
    ...
    max_min_lower_condition_80_observed = thr - supGa_max_observed_80*tau*observed_cohen_d_std;
    max_min_upper_condition_80_observed = thr - supGa_min_observed_80*tau*observed_cohen_d_std;
    max_min_lower_condition_90_observed = thr - supGa_max_observed_90*tau*observed_cohen_d_std;
    max_min_upper_condition_90_observed = thr - supGa_min_observed_90*tau*observed_cohen_d_std;
    max_min_lower_condition_95_observed = thr - supGa_max_observed_95*tau*observed_cohen_d_std;
    max_min_upper_condition_95_observed = thr - supGa_min_observed_95*tau*observed_cohen_d_std;
