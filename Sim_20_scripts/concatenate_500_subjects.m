...
Sim = 'Sim_20'; 
Nfiles = 600; 
Base = sprintf(['/storage/maullz/Contour_Inference_2019/', Sim, '_results/500_subjects']);
...
x.max_min_percentage_success_vector_raw_80_alternate = mean(x.max_min_subset_success_vector_raw_80_alternate, 1); 
x.max_min_percentage_success_vector_raw_90_alternate = mean(x.max_min_subset_success_vector_raw_90_alternate, 1);
x.max_min_percentage_success_vector_raw_95_alternate = mean(x.max_min_subset_success_vector_raw_95_alternate, 1);
x.max_min_percentage_success_vector_observed_80_alternate = mean(x.max_min_subset_success_vector_observed_80_alternate, 1); 
x.max_min_percentage_success_vector_observed_90_alternate = mean(x.max_min_subset_success_vector_observed_90_alternate, 1);
x.max_min_percentage_success_vector_observed_95_alternate = mean(x.max_min_subset_success_vector_observed_95_alternate, 1);
