...
for t=1:nRlz
    ...
    observed_std  = zeros(prod(dim),1);
      ...
      monte_carlo_cohen_d_boundary_values(:,t) = getBdryvalues(sqrt(nSubj)*(reshape(observed_cohen_d, dim) - thr)./cohen_resid_std, Sig_boundary_edges);
      cohen_resid_std_boundary_values = getBdryvalues(cohen_resid_std, Sig_boundary_edges);
      observed_cohen_resid_std_boundary_values = getBdryvalues(cohen_resid_std, observed_boundary_edges);
