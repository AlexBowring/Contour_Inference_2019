results_mat_dir = '/Users/maullz/Desktop/Contour_Inference_2019/Figures/2D_Figures';
...
for i = 1:length(nominal_vec)
    ...
    if i == length(nominal_vec)
        % create legend
        lgd = legend('Ramp, Homo. Variance (est. boundary)', ...
                     'Ramp, Homo. Variance (true boundary)', ...
                     'Ramp, Hetro. Variance (est. boundary)', ...
                     'Ramp, Hetro. Variance (true boundary)', ...
...
fh = gcf;
set(fh,'color','w');
export_fig(fh,fullfile(results_mat_dir,'linear_ramp_coverage_results.pdf'))
...
for i = 1:length(nominal_vec)
    ...
    if i == length(nominal_vec)
        % create legend
        lgd = legend('Circle, Homo. Variance (est. boundary)', ...
                     'Circle, Homo. Variance (true boundary)', ...
                     'Circle, Hetro. Variance (est. boundary)', ...
                     'Circle, Hetro. (true boundary)', ...
                     'Nominal Coverage Level', ...
                     '1.96 * Std Error');
    end   
